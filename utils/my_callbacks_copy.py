...
class MyCallBacks(DefaultCallbacks):
    ...
    def on_episode_created(
        ...
        **kwargs,
        ...
        """
        print("episode.custom_metrics:", episode.custom_metrics)
        if 'custom_agent_rewards_end_train_iter' not in episode.custom_metrics.keys():
            episode.custom_metrics['custom_agent_rewards_end_train_iter'] = {
                agent_id:[] for agent_id in base_env.get_agent_ids()
                }
        print("episode.get_agents()", base_env.get_agent_ids())
        print("episode.custom_metrics['custom_agent_rewards_end_train_iter']", 
              episode.custom_metrics['custom_agent_rewards_end_train_iter'])
    ...
    def on_episode_step(
        ...
        **kwargs,
        ...
        # print("episode.agent_rewards.items():", episode.agent_rewards)
        # print("agent_rewards:", agent_rewards)
        ...
        for agent_id, reward in agent_rewards.items():    
            ...
            episode.custom_metrics['custom_agent_rewards_end_train_iter'][agent_id].append(reward)
    ...
    def on_train_result(
        ...
        **kwargs,
        ...
        for agent_id in agent_ids:
            print("result['custom_metrics']", result['sampler_results']['hist_stats'])
            # last_agent_reward = result['custom_metrics']['custom_agent_rewards_end_train_iter'][agent_id][-1]
